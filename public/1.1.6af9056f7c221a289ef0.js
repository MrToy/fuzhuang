...
/***/ function(module, exports, __webpack_require__) {
	...
	var _component = _wrapComponent('_component')(function (_Component6) {
		...
		function _class4(props) {
			...
			var _this7 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(_class4).call(this, props));

			_this7.state = { carouse: [], carouse2: [], item1: [], item2: [], item3: [], data3: [] };

			fetch("/imgdata?word=服装&len=15&start=15").then(function (res) {
				return res.json();
			}).then(function (data) {
				_this7.setState({ carouse: data });
			});
			fetch("/imgdata?word=服装&len=30&start=200").then(function (res) {
				return res.json();
			}).then(function (data) {
				_this7.setState({ carouse2: data });
			});
			return _this7;
		}
