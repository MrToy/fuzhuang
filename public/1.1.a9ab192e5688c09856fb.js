...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends2 = __webpack_require__(467);
	...
	var _homeToyDesktopFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/home/toy/Desktop/fuzhuang/src/index.jsx',
	...
	var MenuBar = _wrapComponent('MenuBar')((0, _radium2.default)(_class = function (_Component) {
		...
		(0, _createClass3.default)(MenuBar, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'div',
					{ style: { background: _main.colors.primary } },
					_react3.default.createElement(
						'ul',
						{ style: { width: 1200, height: 35, margin: "0 auto" } },
						_react3.default.createElement(
							'li',
							{ style: { width: 180, textAlign: "center", float: "left", listStyle: "none", fontWeight: "bold", lineHeight: "35px", color: "#fff", fontSize: 16, background: _main.colors.secondary } },
							'所有商品分类'
						),
						(this.props.data || []).map(function (it) {
							return _react3.default.createElement(
								'li',
								{ key: it, style: { height: 35, float: "left", listStyle: "none", ":hover": { background: _main.colors.secondary } } },
								_react3.default.createElement(
									'a',
	...
	var MenuLeft = _wrapComponent('MenuLeft')((0, _radium2.default)(_class2 = function (_Component2) {
		(0, _inherits3.default)(MenuLeft, _Component2);
		...
		(0, _createClass3.default)(MenuLeft, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'ul',
					{ style: { width: 178, height: 549, display: "inline-block", background: _main.colors.bg, borderLeft: "1px solid " + _main.colors.line, borderRight: "1px solid " + _main.colors.line, borderBottom: "1px solid " + _main.colors.line } },
					["精品男装", "淘款市场", "国际名流", "意法男装", "中纺服饰", "一号基地", "二号基地", "男衬衫", "品牌折扣", "外贸原单", "三号基地", "更多市场"].map(function (ii) {
						return _react3.default.createElement(
							...
							_react3.default.createElement(
								'a',
								{ key: ii + ".child", style: { textAlign: "center", fontWeight: "normal", width: "100%", lineHeight: "35px", float: "left", color: "#000", ":hover": { color: _main.colors.primary }, fontSize: 16 }, href: "/target/" + ii },
								ii
							)
						);
					})
	...
	var InfoPanel = _wrapComponent('InfoPanel')(function (_Component3) {
		(0, _inherits3.default)(InfoPanel, _Component3);
		...
		(0, _createClass3.default)(InfoPanel, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'div',
					{ style: { display: "inline-block", verticalAlign: "top", width: 218, height: 528, margin: "20px 0 0 20px", border: "1px solid " + _main.colors.line } },
					_react3.default.createElement('div', { style: { height: 100, lineHeight: "100px", textAlign: "center", color: "#444" } }),
					_react3.default.createElement(
						'div',
						{ style: { height: 40, background: _main.colors.bg, borderTop: "1px solid " + _main.colors.line, borderBottom: "1px solid " + _main.colors.line } },
						_react3.default.createElement(
							'a',
							{ href: '#', style: { color: "#444", display: "inline-block", width: 108, height: "100%", borderRight: "1px solid " + _main.colors.line, lineHeight: "40px", textAlign: "center" } },
							'登录'
						),
						_react3.default.createElement(
							'a',
							{ href: '#', style: { color: "#444", display: "inline-block", width: 109, lineHeight: "40px", textAlign: "center" } },
							'注册'
						)
					)
				);
	...
	var TitleBar = _wrapComponent('TitleBar')(function (_Component4) {
	...
	var ItemPanel = _wrapComponent('ItemPanel')((0, _radium2.default)(_class3 = function (_Component5) {
		(0, _inherits3.default)(ItemPanel, _Component5);
		...
		(0, _createClass3.default)(ItemPanel, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'div',
					{ style: { padding: 10, float: "left", width: 202, margin: "0 20px 20px 0", height: 270, border: "1px solid " + _main.colors.line } },
					_react3.default.createElement(
						'p',
						{ style: { marginBottom: 10, height: 200, position: "relative" } },
						_react3.default.createElement(
							'a',
							{ href: '#', style: { height: "100%" } },
							_react3.default.createElement('img', { src: this.props.img, style: { maxWidth: "100%", maxHeight: "100%", position: "absolute", top: 0, bottom: 0, margin: "auto" } })
						)
					),
					_react3.default.createElement(
						'a',
						{ href: '#', style: { color: "#555", ":hover": { color: _main.colors.primary } } },
						_react3.default.createElement(
							'p',
							{ style: { height: 38, overflow: "hidden", textOverflow: "ellipsis" } },
							this.props.text
						)
					),
					_react3.default.createElement(
						'p',
						{ style: { height: 20, overflow: "hidden", textOverflow: "ellipsis", color: _main.colors.primary } },
						_react3.default.createElement(
							'b',
							null,
							'￥'
	...
	var Carouse = _wrapComponent('Carouse')((0, _radium2.default)(_class4 = function (_Component6) {
		(0, _inherits3.default)(Carouse, _Component6);

		function Carouse(props) {
			(0, _classCallCheck3.default)(this, Carouse);

			var _this6 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Carouse).call(this, props));

			_this6.state = { index: 0 };
			_this6.start();
			return _this6;
		}
		...
		(0, _createClass3.default)(Carouse, [{
			...
			value: function start() {
				...
				this.t = setInterval(function () {
					if (_radium2.default.getState(_this7.state, 'box', ':hover')) return;
					_this7.next();
				}, 5000);
			}
		}, {
				...
				return _react3.default.createElement(
						...
						_react3.default.createElement(
							...
							this.props.data.map(function (it, i) {
								return _react3.default.createElement(
									...
									_react3.default.createElement(
										'li',
										{ style: { display: "inline-block", width: 760, height: "100%" } },
										_react3.default.createElement('img', { src: __webpack_require__(463), style: { width: "100%", height: "100%" } })
									)
								);
							})
						)
					...
					_react3.default.createElement(
						...
						{ key: 'left', onClick: function onClick() {
								return _this8.pre();
							}, style: { fill: "#fff", ":hover": { fill: _main.colors.primary }, display: _radium2.default.getState(this.state, 'box', ':hover') ? "block" : "none", cursor: "pointer", padding: 10, position: "absolute", top: 0, bottom: 0, margin: "auto", width: 50, height: 50 }, viewBox: '0 0 16 16' },
					...
					_react3.default.createElement(
						...
						{ key: 'right', onClick: function onClick() {
								return _this8.next();
							}, style: { fill: "#fff", ":hover": { fill: _main.colors.primary }, display: _radium2.default.getState(this.state, 'box', ':hover') ? "block" : "none", cursor: "pointer", padding: 10, position: "absolute", right: 0, top: 0, bottom: 0, margin: "auto", width: 50, height: 50 }, viewBox: '0 0 16 16' },
					...
					_react3.default.createElement(
						...
						this.props.data.map(function (it, i) {
							return _react3.default.createElement('li', { key: "item" + i, onClick: function onClick() {
									return _this8.setState({ index: i });
								}, style: { cursor: "pointer", width: 18, height: 18, border: "1px solid #fff", margin: "0 5px", borderRadius: 10, display: "inline-block", background: _this8.state.index == i ? _main.colors.primary : "rgba(200,200,200,0.3)", ":hover": _this8.state.index == i ? {} : { background: "rgba(200,200,200,0.6)" } } });
						})
					)
				);
			}
	...
	var Carouse2 = _wrapComponent('Carouse2')(function (_Component7) {
		...
		(0, _createClass3.default)(Carouse2, [{
			key: 'render',
			value: function render() {
				return _react3.default.createElement('div', { style: { height: 160, background: _main.colors.bg } });
			}
		}]);
		return Carouse2;
	}(_react2.Component));

	var MainBar = _wrapComponent('MainBar')(function (_Component8) {
		(0, _inherits3.default)(MainBar, _Component8);
	...
	var ItemList = _wrapComponent('ItemList')((0, _radium2.default)(_class5 = function (_Component9) {
		(0, _inherits3.default)(ItemList, _Component9);
	...
	var z = { img: __webpack_require__(463), text: "潮流单品", price: 300 };

	var _component = _wrapComponent('_component')(function (_Component10) {
		(0, _inherits3.default)(_class6, _Component10);

		function _class6() {
			(0, _classCallCheck3.default)(this, _class6);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(_class6).apply(this, arguments));
		}
		...
		(0, _createClass3.default)(_class6, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'div',
					null,
					_react3.default.createElement(MenuBar, { data: ["网站首页", "批发市场", "每日新款", "款式搜索"] }),
					_react3.default.createElement(MainBar, null),
					_react3.default.createElement(ItemList, { title: '潮流单品', data: [z, z, z, z, z, z, z, z, z, z] }),
					_react3.default.createElement(ItemList, { title: '潮流单品', data: [z, z, z, z, z, z, z, z, z, z] })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign = __webpack_require__(468)["default"];
