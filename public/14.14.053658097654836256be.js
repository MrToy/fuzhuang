...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Modal = __webpack_require__(650);

	var _Modal2 = _interopRequireDefault(_Modal);

	var _ImageFileModal = __webpack_require__(671);
	...
	var Goods = _wrapComponent("Goods")(function (_Component2) {
		...
		function Goods() {
			...
			return _ret2 = (_temp3 = (_this3 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO2 = (0, _getPrototypeOf2.default)(Goods)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this3), _this3.state = { addModal: false, name: "", info: "", imgs: [], data: [], pages: 0 }, _temp3), (0, _possibleConstructorReturn3.default)(_this3, _ret2);
		}

		(0, _createClass3.default)(Goods, [{
			key: "onData",
			value: function onData(it) {
				var _this4 = this;

				var data = it.data.map(function (it) {
					return { id: it._id, name: it.name, info: it.info, img: _react3.default.createElement(_Image2.default, { style: { width: 100, height: 100 }, src: (it.imgs[0] || {}).path }), buttons: _react3.default.createElement(
							_Button2.default,
							{ onClick: function onClick() {
									_this4.refs.del.request("/goods/" + it._id + "?token=" + _store2.default.get("token"));
									_this4.refs.get.request();
								} },
							"删除"
						) };
				});
				this.setState({ data: data, pages: Math.ceil(it.total / 5) });
			}
		}, {
			key: "onPaging",
			value: function onPaging(i) {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						{ style: { marginBottom: 20 }, onClick: function onClick() {
								return _this5.setState({ addModal: true });
							} },
						"添加"
					),
					_react3.default.createElement(
						...
						{ isOpen: this.state.addModal, onRequestClose: function onRequestClose() {
								return _this5.setState({ addModal: false });
							} },
						...
						_react3.default.createElement(_ImageFileModal.FormImageButton, { onCheck: function onCheck(imgs) {
								return _this5.setState({ imgs: imgs });
							} }),
						_react3.default.createElement(
							_Col2.default,
							{ sm: 4, offset: 8 },
							_react3.default.createElement(
								_Button2.default,
								{ onClick: function onClick() {
										return _this5.refs.post.request();
									} },
								"确定"
							),
							_react3.default.createElement(
					...
					_react3.default.createElement(_Table2.default, { border: true, keys: ["ID", "商品名", "商品简介", "主图", "操作"], data: this.state.data }),
					_react3.default.createElement(_Paging2.default, { style: { marginTop: 20 }, total: this.state.pages, onPaging: this.onPaging.bind(this) }),
					_react3.default.createElement(_Ajax2.default, { ref: "post", url: "/goods?token=" + _store2.default.get("token"), method: "post", data: (0, _stringify2.default)({ name: this.state.name, info: this.state.info, imgs: this.state.imgs }), onSuccess: function onSuccess() {
							_this5.setState({ addModal: false });
							_this5.refs.get.request();
						}, alert: true }),
					_react3.default.createElement(_Ajax2.default, { ref: "del", method: "delete", alert: true }),
					_react3.default.createElement(_Ajax2.default, { auto: true, ref: "get", url: "/goods?shop=" + this.props.data._id + "&limit=5", onSuccess: this.onData.bind(this) })
				);
			}
		}]);
		return Goods;
	...
	var Apply = _wrapComponent("Apply")(function (_Component3) {
		...
		function Apply() {
			...
			return _ret3 = (_temp4 = (_this6 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO3 = (0, _getPrototypeOf2.default)(Apply)).call.apply(_Object$getPrototypeO3, [this].concat(args))), _this6), _this6.state = { active: false, name: "", info: "" }, _temp4), (0, _possibleConstructorReturn3.default)(_this6, _ret3);
		}
		...
		(0, _createClass3.default)(Apply, [{
			...
			value: function render() {
				...
				return this.state.active ? _react3.default.createElement(
					...
					_react3.default.createElement(_Input2.default, { onChange: function onChange(e) {
							return _this7.setState({ info: e.target.value });
						}, label: "简介", type: "textarea" }),
					_react3.default.createElement(
						_Button2.default,
						{ onClick: function onClick() {
								return _this7.refs.ajax.request();
							} },
						"提交申请"
					),
					...
					_react3.default.createElement(
						_Button2.default,
						{ collapse: true, onClick: function onClick() {
								return _this7.setState({ active: true });
							} },
						"申请店铺"
					)
				);
	...
	var _component = _wrapComponent("_component")(function (_Component4) {
		...
		function _class5() {
			...
			return _ret4 = (_temp5 = (_this8 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO4 = (0, _getPrototypeOf2.default)(_class5)).call.apply(_Object$getPrototypeO4, [this].concat(args))), _this8), _this8.state = { info: null }, _temp5), (0, _possibleConstructorReturn3.default)(_this8, _ret4);
		}
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Ajax2.default, { auto: true, url: "/shops/info?token=" + _store2.default.get("token"), onSuccess: function onSuccess(info) {
							return _this9.setState({ info: info });
						} })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactModal = __webpack_require__(651);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalPortal = React.createFactory(__webpack_require__(653));
	var ariaAppHider = __webpack_require__(669);
	var elementClass = __webpack_require__(670);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusManager = __webpack_require__(654);
	var scopeTab = __webpack_require__(656);
	var Assign = __webpack_require__(657);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(655);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseAssign = __webpack_require__(658),
	    createAssigner = __webpack_require__(664),
	    keys = __webpack_require__(668);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var baseCopy = __webpack_require__(659),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(661),
	    isArguments = __webpack_require__(662),
	    isArray = __webpack_require__(663);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var bindCallback = __webpack_require__(665),
	    isIterateeCall = __webpack_require__(666),
	    restParam = __webpack_require__(667);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FileManager = __webpack_require__(672);
	...
	var _AjaxFileManager = __webpack_require__(673);
		...
		(0, _createClass3.default)(FormImageButton, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(ImageLine, { data: this.state.checked, style: { margin: "5px 0 0 0" } })
				);
			}
		}]);
