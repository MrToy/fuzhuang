...
/***/ function(module, exports, __webpack_require__) {
	...
	var Info = _wrapComponent("Info")(function (_Component) {
		...
		(0, _createClass3.default)(Info, [{
			...
			value: function render() {
				return _react3.default.createElement(
					"div",
					(0, _extends3.default)({}, this.props, { style: { lineHeight: "50px", textAlign: "center" } }),
					_react3.default.createElement(
						"div",
						{ style: { display: "inline-block", width: 500, height: 250, verticalAlign: "top" } },
						_react3.default.createElement(
							"h3",
							null,
							"店铺名"
	...
	var Config = _wrapComponent("Config")(function (_Component2) {
		(0, _inherits3.default)(Config, _Component2);

		function Config() {
			(0, _classCallCheck3.default)(this, Config);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Config).apply(this, arguments));
		}
		...
		(0, _createClass3.default)(Config, [{
			...
			value: function render() {
				return _react3.default.createElement(
					"div",
					(0, _extends3.default)({}, this.props, { style: { lineHeight: "50px" } }),
					_react3.default.createElement(
						"p",
						null,
						"店铺名称 ",
	...
	var Identity = _wrapComponent("Identity")(function (_Component3) {
		(0, _inherits3.default)(Identity, _Component3);

		function Identity() {
			(0, _classCallCheck3.default)(this, Identity);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Identity).apply(this, arguments));
		}
			...
			value: function render() {
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						_.MenuPanel,
						null,
						_react3.default.createElement(Info, { title: "概览" }),
						_react3.default.createElement(Config, { title: "设置" }),
						_react3.default.createElement(Identity, { title: "认证" })
					)
				);
			}
		}]);
