		...
		(0, _createClass3.default)(Goods, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Table2.default, { border: true, keys: ["商品名", "商品简介", "主图"], data: this.state.data }),
					...
					_react3.default.createElement(_Ajax2.default, { auto: true, ref: "ajax", url: "/goods?shop=" + this.props.data._id, onSuccess: function onSuccess(data) {
							return _this4.setState({
								data: data.map(function (it) {
									return { name: it.name, info: it.info, img: _react3.default.createElement(_Image2.default, { style: { width: 100, height: 100 }, src: it.imgs[0].path }) };
								})
							});
						} })
				);
