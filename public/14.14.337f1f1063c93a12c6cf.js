...
/***/ function(module, exports, __webpack_require__) {
	...
	var Goods = _wrapComponent("Goods")(function (_Component2) {
		...
		function Goods() {
			...
			return _ret2 = (_temp3 = (_this3 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO2 = (0, _getPrototypeOf2.default)(Goods)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this3), _this3.state = { addModal: false, name: "", info: "", price: 9999, imgs: [], data: [], pages: 0 }, _temp3), (0, _possibleConstructorReturn3.default)(_this3, _ret2);
		}
		...
		(0, _createClass3.default)(Goods, [{
			...
			value: function onData(it) {
				...
				var data = it.data.map(function (it) {
					return { id: it._id, name: it.name, price: it.price, info: it.info, img: _react3.default.createElement(_Image2.default, { style: { width: 100, height: 100 }, src: (it.imgs[0] || {}).path }), buttons: _react3.default.createElement(
							_Button2.default,
							{ onClick: function onClick() {
			...
			value: function onPaging(i) {
				this.refs.get.url = "/goods?shop=" + this.props.data._id + "&limit=5&skip=" + (i - 1) * 5;
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Table2.default, { border: true, keys: ["ID", "商品名", "价格", "商品简介", "主图", "操作"], data: this.state.data }),
					...
					_react3.default.createElement(_Ajax2.default, { ref: "post", url: "/goods?token=" + _store2.default.get("token"), method: "post", data: (0, _stringify2.default)({ name: this.state.name, info: this.state.info, imgs: this.state.imgs, price: this.state.price }), onSuccess: function onSuccess() {
