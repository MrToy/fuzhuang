				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							...
							_react3.default.createElement(_Ajax2.default, { ref: "ajax", url: "/goods?token=" + _store2.default.get("token"), method: "post", data: (0, _stringify2.default)({ name: this.state.name, info: this.state.info, imgs: this.state.imgs }), onSuccess: function onSuccess() {}, alert: true })
						),
						_react3.default.createElement(
							_Button2.default,
							null,
