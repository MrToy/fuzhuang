...
/***/ function(module, exports, __webpack_require__) {
	...
	var Goods = _wrapComponent("Goods")(function (_Component2) {
		...
		function Goods() {
			...
			return _ret2 = (_temp3 = (_this3 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO2 = (0, _getPrototypeOf2.default)(Goods)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this3), _this3.state = { addModal: false, name: "", info: "", price: 9999, imgs: [], data: [], pages: 0, index: 1 }, _temp3), (0, _possibleConstructorReturn3.default)(_this3, _ret2);
		}
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Paging2.default, { style: { marginTop: 20 }, total: this.state.pages, onPaging: function onPaging(i) {
							_this5.setState({ index: i });
							_this5.refs.get.request("/goods?shop=" + _this5.props.data._id + "&limit=5&skip=" + (i - 1) * 5);
						} }),
					...
					_react3.default.createElement(_Ajax2.default, { auto: true, ref: "get", url: "/goods?shop=" + this.props.data._id + "&limit=5&skip=" + (this.state.index - 1) * 5, onSuccess: this.onData.bind(this) })
				);
			}
		}]);
		return Goods;
