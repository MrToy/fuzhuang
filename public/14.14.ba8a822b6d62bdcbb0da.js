	...
	var RollLine = _wrapComponent('RollLine')((0, _radium2.default)(_class = function (_Component) {
		...
		(0, _createClass3.default)(RollLine, [{
			...
			value: function render() {
				...
				return _react3.default.createElement('div', { style: { height: 2, animationName: keys, animation: "x 5s ease 0s infinite", position: "fixed", top: 0, left: 0, zIndex: 999, background: "#0E90D2" } });
			}
		}]);
		return RollLine;
