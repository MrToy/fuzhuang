		...
		(0, _createClass3.default)(Goods, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							...
							_react3.default.createElement(
								_Button2.default,
								{ onClick: function onClick() {
										return _this4.refs.ajax.request();
									} },
								"确定"
							),
							_react3.default.createElement(
						...
						_react3.default.createElement(_Ajax2.default, { ref: "ajax", url: "/goods?token=" + _store2.default.get("token"), method: "post", data: (0, _stringify2.default)({ name: this.state.name, info: this.state.info, imgs: this.state.imgs }), onSuccess: function onSuccess() {
								return _this4.setState({ addModal: false });
							}, alert: true })
					),
					...
					_react3.default.createElement(_Ajax2.default, { auto: true, ref: "ajax", url: "/goods?shop=" + this.props.data._id, onSuccess: function onSuccess(data) {
