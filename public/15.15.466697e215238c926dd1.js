...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuPanel = __webpack_require__(652);
	...
	var _homeToyDesktopFuFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/home/toy/Desktop/fu/fuzhuang/src/user/goods.jsx',
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
			...
			value: function render() {
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						_MenuPanel2.default,
						null,
						_react3.default.createElement('div', { title: '商品一览' })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeToyDesktopFuFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: "/home/toy/Desktop/fu/fuzhuang/src/lib/MenuPanel.jsx",
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
	...
	var _component = _wrapComponent("_component")(function (_Component) {
		...
		function _class2() {
			...
			return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(_class2)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = { choosed: 0 }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
		}
		...
		(0, _createClass3.default)(_class2, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						"ul",
						{ style: { marginBottom: 30, listStyle: "none", fontSize: 20, borderBottom: "1px solid #EEE" } },
						_react3.default.Children.map(this.props.children, function (it, i) {
							var lineColor = _this2.state.choosed == i ? "#000" : "rgba(0,0,0,0)";
							var fontColor = _this2.state.choosed == i ? "#000" : "#AAA";
							return _react3.default.createElement(
								"li",
								{ onClick: function onClick() {
										return _this2.setState({ choosed: i });
									}, style: { cursor: "pointer", display: "inline-block", padding: "10px 20px", borderBottom: "2px solid " + lineColor, color: fontColor } },
								it.props.title
							);
						})
