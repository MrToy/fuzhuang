...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extPjspaceFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/ext/pjspace/fuzhuang/src/user/web.jsx',
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
	...
	var _component = _wrapComponent('_component')(function (_Component) {
		...
		function _class2() {
			...
			return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(_class2)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = { imgs1: [], imgs2: [] }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
		}
		...
		(0, _createClass3.default)(_class2, [{
			...
			value: function render() {
				...
				var imgs1 = _state.imgs1;
				var imgs2 = _state.imgs2;
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						_Input.FormGroup,
						{ horizontal: true, label: '主页主轮播图片' },
						_react3.default.createElement(_ImageFileModal.FormImageButton, { data: imgs1, ref: 'imgs1', onCheck: function onCheck(imgs) {
								return _this2.setState({ imgs1: imgs });
							} })
					),
					_react3.default.createElement(
						_Input.FormGroup,
						{ horizontal: true, label: '主页次轮播图片' },
						_react3.default.createElement(_ImageFileModal.FormImageButton, { data: imgs2, ref: 'imgs2', onCheck: function onCheck(imgs) {
								return _this2.setState({ imgs2: imgs });
							} })
					),
					_react3.default.createElement(
						_Input.FormGroup,
					...
					_react3.default.createElement(_Ajax2.default, { auto: true, ref: 'get', url: "/configs/index", onSuccess: function onSuccess(it) {
							return _this2.setState({ imgs1: it.imgs1, imgs2: it.imgs2 });
						} }),
					_react3.default.createElement(_Ajax2.default, { ref: 'post', url: "/configs/index?token=" + _store2.default.get("token"), method: 'post', data: (0, _stringify2.default)({ imgs1: this.state.imgs1, imgs2: this.state.imgs2 }), alert: true })
				);
			}
		}]);
		return _class2;
