		...
		(0, _createClass3.default)(Menu, [{
			...
			value: function render() {
				return _react3.default.createElement(
					...
					[{ title: "分类：", list: ["全部", "女装", "男装", "鞋", "内衣", "母婴用品", "配件箱包", "运动户外", "美妆饰品"] }, { title: "市场：", list: ["全部", "国大", "大西豪", "女人街", "国投", "富丽", "新金马", "大时代", "宝华", "鞋城", "圣迦", "佰润", "西街", "新潮都", "非凡", "柏美", "老金马", "十三行", "欣欣网批", "南城", "新旺角", "周边", "万佳", "益民", "新百佳", "西苑鞋汇", "景叶", "润景", "机筑巷", "万艺鞋汇"] }].map(function (it, i) {
						return _react3.default.createElement(
							'p',
							...
							it.list.map(function (itit) {
								return _react3.default.createElement(
									'a',
									{ href: '#', style: { margin: "0 20px", color: i == 0 ? "#555" : "" } },
									it
								);
							})
						);
