...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AvgGrid = __webpack_require__(611);
	...
	var _homeToyDesktopFuFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/home/toy/Desktop/fu/fuzhuang/src/home/GoodsList.jsx',
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GoodsList = __webpack_require__(610);
	...
	var _homeToyDesktopFuFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/home/toy/Desktop/fu/fuzhuang/src/home/search.jsx',
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
	...
	var MenuButton = exports.MenuButton = _wrapComponent('MenuButton')((0, _radium2.default)(_class2 = function (_Component3) {
	...
	var _component = _wrapComponent('_component')(function (_Component4) {
		...
		function _class4() {
			...
			return _ret = (_temp = (_this6 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(_class4)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this6), _this6.state = { sort: "", menu: {}, index: 1, direct: 0, pages: 0, data: [], word: null }, _temp), (0, _possibleConstructorReturn3.default)(_this6, _ret);
		}

		(0, _createClass3.default)(_class4, [{
			key: 'onSort',
			value: function onSort(i) {
				var _this7 = this;
				...
				this.setState({ sort: sort }, function () {
					return _this7.refs.get.request();
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						_main.TitleBar,
						null,
						_react3.default.createElement(_main.Search, { refs: 'search', placeholder: this.props.location.query.word, onSearch: function onSearch(word) {
								return _this8.setState({ word: word }, function () {
									return _this8.refs.get.request();
								});
							} })
					),
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(Menu, { onChange: function onChange(it) {
								return _this8.setState({ menu: it });
							} }),
						_react3.default.createElement(
							_ButtonGroup2.default,
							{ onCheck: this.onSort.bind(this), style: { marginBottom: 20 } },
							_react3.default.createElement(
								_Button2.default,
								{ color: 'red' },
								'综合'
						...
						_react3.default.createElement(
							...
							{ color: 'red', onClick: function onClick() {
									return _this8.setState({ direct: !_this8.state.direct }, function () {
										return _this8.refs.get.request();
									});
								} },
							this.state.direct ? "↑升序" : "↓降序"
						),
						_react3.default.createElement(_GoodsList2.default, { data: this.state.data }),
						_react3.default.createElement(_Paging2.default, { color: 'red', total: this.state.pages, style: { display: "inline-block" }, onPaging: function onPaging(i) {
								return _this8.setState({ index: i }, function () {
									return _this8.refs.get.request();
								});
							} }),
						_react3.default.createElement(_Ajax2.default, { auto: true, ref: 'get', url: "/goods?limit=15&sort=" + this.state.sort + "," + (this.state.direct ? "+" : "-") + "&word=" + (this.state.word || this.props.location.query.word) + "&onSale=true&skip=" + (this.state.index - 1) * 15, onSuccess: function onSuccess(it) {
								return _this8.setState({ data: it.data, pages: Math.ceil(it.total / 15) });
							} })
					),
