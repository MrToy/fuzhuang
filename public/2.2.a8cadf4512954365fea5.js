		...
		(0, _createClass3.default)(Paging, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					'到第',
					_react3.default.createElement('input', { ref: 'page', type: 'number', style: { margin: "0 5px", width: 60, height: 40, lineHeight: "40px", padding: "0 10px", border: "1px solid " + _main.colors.line } }),
					'页',
					_react3.default.createElement(
						MenuButton,
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						_main.TitleBar,
						null,
						_react3.default.createElement(_main.Search, { refs: 'search', placeholder: this.props.location.query.word })
					),
