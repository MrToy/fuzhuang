...
/***/ function(module, exports, __webpack_require__) {
		...
		(0, _createClass3.default)(MenuList, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					'div',
					{ style: { borderBottom: "1px solid " + _main.colors.line, padding: "0 20px", transition: "all 0.3s", lineHeight: "50px", height: !this.props.more || this.state.open ? "auto" : 50, overflow: "hidden" } },
					...
					_react3.default.createElement(
						...
						this.state.open ? _react3.default.createElement(
							'div',
							null,
							_react3.default.createElement(
								'span',
							...
							_react3.default.createElement(
								'svg',
								{ style: { display: "inline-block", width: 15, height: 15, verticalAlign: "middle", margin: "0 2px" }, viewBox: '0 0 20 20' },
								_react3.default.createElement('path', { fill: '#000000', d: 'M0 15c0 0.128 0.049 0.256 0.146 0.354 0.195 0.195 0.512 0.195 0.707 0l8.646-8.646 8.646 8.646c0.195 0.195 0.512 0.195 0.707 0s0.195-0.512 0-0.707l-9-9c-0.195-0.195-0.512-0.195-0.707 0l-9 9c-0.098 0.098-0.146 0.226-0.146 0.354z' })
							)
						) : _react3.default.createElement(
							'div',
							null,
	...
	var Menu = _wrapComponent('Menu')(function (_Component2) {
		...
		(0, _createClass3.default)(Menu, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'div',
					{ style: { margin: "20px 0", border: "1px solid " + _main.colors.line, color: "#888" } },
	...
	var SortBar = _wrapComponent('SortBar')(function (_Component3) {
		(0, _inherits3.default)(SortBar, _Component3);

		function SortBar() {
			(0, _classCallCheck3.default)(this, SortBar);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(SortBar).apply(this, arguments));
		}
		...
		(0, _createClass3.default)(SortBar, [{
			...
			value: function render() {
				return _react3.default.createElement(
					'ul',
					{ style: { listStyle: "none", border: "1px solid " + _main.colors.line, width: 500, color: "#888" } },
					["综合", "价格", "上新时间", "热度"].map(function (it) {
						return _react3.default.createElement(
							'li',
							{ style: { cursor: "pointer", display: "inline-block", padding: "10px 20px", borderRight: "1px solid " + _main.colors.line } },
							it
						);
					})
				);
	...
	var _component = _wrapComponent('_component')(function (_Component4) {
		(0, _inherits3.default)(_class, _Component4);
