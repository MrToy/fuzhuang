					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							...
							_react3.default.createElement(
								'span',
								null,
								this.state.open ? "更多" : "收起"
							),
							_react3.default.createElement(
								'svg',
								{ style: { transform: this.state.open ? "rotate(180deg)" : "rotate:(0deg)", display: "inline-block", width: 15, height: 15, verticalAlign: "middle", margin: "0 2px" }, viewBox: '0 0 20 20' },
