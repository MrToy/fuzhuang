...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extPjspaceFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/ext/pjspace/fuzhuang/src/home/item.jsx',
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(_Image2.default, { border: true, style: { width: 400, height: 400 }, src: data.imgs[0] ? data.imgs[0].path : __webpack_require__(629) }),
						_react3.default.createElement(
							'div',
							null,
							data.imgs.slice(1).map(function (it, i) {
								return _react3.default.createElement(_Image2.default, { border: true, style: { width: 78, height: 78, margin: 10 }, src: it.path || __webpack_require__(629) });
							})
						)
					),
					_react3.default.createElement(
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							...
							data.imgs.map(function (it) {
								return _react3.default.createElement(
									'div',
									{ style: { padding: 50 } },
									_react3.default.createElement(_Image2.default, { style: { width: "auto", height: "auto" }, src: it.path })
								);
							})
						)
					)
	...
	var _component = _wrapComponent('_component')(function (_Component3) {
		...
		function _class2() {
			...
			return _ret = (_temp = (_this3 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(_class2)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.state = { data: null }, _temp), (0, _possibleConstructorReturn3.default)(_this3, _ret);
		}
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(ItemInfo, { data: this.state.data }),
						_react3.default.createElement(ImageInfo, { data: this.state.data })
					),
					_react3.default.createElement(_main.Footer, null),
					_react3.default.createElement(_Ajax2.default, { auto: true, url: "/goods/" + this.props.location.query.id, onSuccess: function onSuccess(it) {
							return _this4.setState({ data: it });
						} })
				);
			}
		}]);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
