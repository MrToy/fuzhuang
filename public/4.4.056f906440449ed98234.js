...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeToyDesktopFuFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: '/home/toy/Desktop/fu/fuzhuang/src/home/login.jsx',
	...
	var LoginPanel = _wrapComponent('LoginPanel')((0, _radium2.default)(_class = function (_Component) {
		...
		function LoginPanel() {
			...
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LoginPanel).apply(this, arguments));
		}
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									_context.next = 4;
									return fetch('/auth', { method: 'post', body: (0, _stringify2.default)({ account: account, pass: pass }) });
								...
								case 13:
									...
									_context.t1.set.call(_context.t1, 'user', _context.t2);
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						'div',
						{ style: { border: "1px solid " + _main.colors.line } },
						_react3.default.createElement(
							'svg',
							{ style: { fill: "#888", display: "inline", verticalAlign: "top", width: 30, height: 30, padding: 10, background: _main.colors.bg, borderRight: "1px solid " + _main.colors.line }, viewBox: '0 0 20 20' },
							_react3.default.createElement('path', { d: 'M9.5 20c-2.538 0-4.923-0.988-6.718-2.782s-2.782-4.18-2.782-6.717c0-2.538 0.988-4.923 2.782-6.718s4.18-2.783 6.718-2.783c2.538 0 4.923 0.988 6.718 2.783s2.782 4.18 2.782 6.718-0.988 4.923-2.782 6.717c-1.794 1.794-4.18 2.782-6.718 2.782zM9.5 2c-4.687 0-8.5 3.813-8.5 8.5s3.813 8.5 8.5 8.5 8.5-3.813 8.5-8.5-3.813-8.5-8.5-8.5z' }),
							_react3.default.createElement('path', { d: 'M6.5 8c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5zM6.5 6c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5 0.5-0.224 0.5-0.5-0.224-0.5-0.5-0.5z' }),
							_react3.default.createElement('path', { d: 'M12.5 8c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5zM12.5 6c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5 0.5-0.224 0.5-0.5-0.224-0.5-0.5-0.5z' }),
							_react3.default.createElement('path', { d: 'M9.5 17c-3.584 0-6.5-2.916-6.5-6.5 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 3.033 2.467 5.5 5.5 5.5s5.5-2.467 5.5-5.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 3.584-2.916 6.5-6.5 6.5z' })
						),
						_react3.default.createElement('input', { ref: 'account', style: { display: "inline", border: "none", height: 50, fontSize: 30, width: 280, paddingLeft: 10 } })
					),
					_react3.default.createElement(
						'div',
						{ style: { border: "1px solid " + _main.colors.line, marginTop: 30 } },
						_react3.default.createElement(
							'svg',
							{ style: { fill: "#888", display: "inline", verticalAlign: "top", width: 30, height: 30, padding: 10, background: _main.colors.bg, borderRight: "1px solid " + _main.colors.line }, viewBox: '0 0 20 20' },
							_react3.default.createElement('path', { d: 'M14.5 8h-0.5v-1.5c0-2.481-2.019-4.5-4.5-4.5s-4.5 2.019-4.5 4.5v1.5h-0.5c-0.827 0-1.5 0.673-1.5 1.5v8c0 0.827 0.673 1.5 1.5 1.5h10c0.827 0 1.5-0.673 1.5-1.5v-8c0-0.827-0.673-1.5-1.5-1.5zM6 6.5c0-1.93 1.57-3.5 3.5-3.5s3.5 1.57 3.5 3.5v1.5h-7v-1.5zM15 17.5c0 0.276-0.224 0.5-0.5 0.5h-10c-0.276 0-0.5-0.224-0.5-0.5v-8c0-0.276 0.224-0.5 0.5-0.5h10c0.276 0 0.5 0.224 0.5 0.5v8z' })
						),
						_react3.default.createElement('input', { ref: 'pass', type: 'password', style: { display: "inline", border: "none", height: 50, fontSize: 30, width: 280, paddingLeft: 10 } })
					),
					_react3.default.createElement(
						'p',
						{ style: { marginTop: 30 } },
					...
					_react3.default.createElement(
						...
						{ onClick: function onClick() {
								return _this2.post();
							}, style: { cursor: "pointer", marginTop: 30, background: _main.colors.primary, color: "#fff", textAlign: "center", lineHeight: "50px", fontSize: 20, fontWeight: "bold" } },
						'登 录'
					)
				);
			}
		...
		(0, _createClass3.default)(_class2, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						'div',
						{ style: { height: 400, width: 1000, margin: "0 auto", padding: "150px 100px" } },
						_react3.default.createElement(
							'div',
							{ style: { width: 450, height: 350, float: "left" } },
							_react3.default.createElement('img', { src: __webpack_require__(468), style: { width: "100%", height: "100%" } })
						),
						_react3.default.createElement(LoginPanel, { onSuccess: function onSuccess() {
								return _this4.props.history.pushState(null, "/");
							}, style: { width: 350, height: 250, float: "right" } })
					),
