						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									_context.prev = 2;
									_context.next = 5;
									return (0, _user.auth)(account, pass);
								...
								case 13:
									...
									(0, _sweetalert2.default)("登录成功", "", "success");
			...
			value: function render() {
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(LoginPanel, { style: { width: 350, height: 250, float: "right" } })
					),
