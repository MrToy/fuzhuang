...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components = {
		...
		RegShortMessageVfc: {
			displayName: 'RegShortMessageVfc'
		},
		RegForm: {
			displayName: 'RegForm'
		},
	...
	var RegShortMessageVfc = _wrapComponent('RegShortMessageVfc')(function (_Component4) {
		(0, _inherits3.default)(RegShortMessageVfc, _Component4);

		function RegShortMessageVfc() {
			(0, _classCallCheck3.default)(this, RegShortMessageVfc);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(RegShortMessageVfc).apply(this, arguments));
		}

		(0, _createClass3.default)(RegShortMessageVfc, [{
			key: 'render',
			value: function render() {}
		}]);
		return RegShortMessageVfc;
	}(_react2.Component));

	var RegForm = _wrapComponent('RegForm')(function (_Component5) {
		(0, _inherits3.default)(RegForm, _Component5);
		...
		function RegForm() {
			...
			return _ret = (_temp = (_this7 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(RegForm)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this7), _this7.state = { account: "", pass: "", repass: "", captcha: "" }, _temp), (0, _possibleConstructorReturn3.default)(_this7, _ret);
		}
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					{ onKeyDown: function onKeyDown(e) {
							e.keyCode == 13 && _this8.refs.post.request();
						} },
					_react3.default.createElement(_Input2.default, { label: '手机号', horizontal: true,
						...
						onChange: function onChange(e) {
							return _this8.setState({ account: e.target.value });
						} }),
					_react3.default.createElement(_Input2.default, { label: '密码', type: 'password', horizontal: true,
						...
						onChange: function onChange(e) {
							return _this8.setState({ pass: e.target.value });
						} }),
					_react3.default.createElement(_Input2.default, { label: '确认密码', type: 'password', horizontal: true,
						...
						onChange: function onChange(e) {
							return _this8.setState({ repass: e.target.value });
						} }),
					_react3.default.createElement(_Input2.default, { label: '短信验证码', horizontal: true,
						...
						onChange: function onChange(e) {
							return _this8.setState({ captcha: e.target.value });
						} }),
					_react3.default.createElement(
						_Input.FormGroup,
						{ horizontal: true },
						_react3.default.createElement(
							_Button2.default,
							{ onClick: function onClick() {
									return _this8.refs.post.request();
								} },
							'注册'
						)
					),
					_react3.default.createElement(_Ajax2.default, { ref: '' }),
					_react3.default.createElement(_Ajax2.default, { ref: 'post', method: 'post', url: "/users", data: (0, _stringify2.default)({ account: account, pass: pass, repass: repass, captcha: captcha, target: target }), onSuccess: function onSuccess(data) {
