		...
		(0, _createClass3.default)(RegForm, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Image2.default, { style: 'height:22px', src: this.state.vfcPicture }),
					_react3.default.createElement(
						_Input.FormGroup,
						{ horizontal: true },
						_react3.default.createElement(
					...
					_react3.default.createElement(_Ajax2.default, { ref: 'post', method: 'post', url: "/users", data: (0, _stringify2.default)({ msg: _store2.default.get('msg'), smsCode: this.state.smsCode }),
						onSuccess: function onSuccess(data) {
