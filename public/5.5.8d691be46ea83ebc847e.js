		...
		(0, _createClass3.default)(RegForm, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Ajax2.default, { ref: 'post', method: 'post', url: "/users?msg=" + _store2.default.get('msg'), data: (0, _stringify2.default)({ userSmsCode: this.state.userSmsCode }),
						onSuccess: function onSuccess(data) {
							_store2.default.set('token', data.token);
							_reactRouter.browserHistory.push("/");
						}, alertShowInputError: true })
				);
			}
		}]);
		return RegForm;
