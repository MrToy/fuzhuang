		...
		(0, _createClass3.default)(RegForm, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(_Input2.default, { label: '短信验证码', horizontal: true,
					...
					_react3.default.createElement(_Ajax2.default, { ref: 'getVfc', url: "/users/vfc", onSuccess: function onSuccess(data) {
							_store2.default.set('content', data.content);
							_this7.setState({ vfcPicture: data.pic });
						} }),
					_react3.default.createElement(_Ajax2.default, { ref: 'sms', method: 'post', url: "/users/vfc", data: (0, _stringify2.default)({ account: account, pass: pass, repass: repass, captcha: captcha, target: target }),
