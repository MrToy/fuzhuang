...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeToyDesktopFuFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: "/home/toy/Desktop/fu/fuzhuang/src/admin/index.jsx",
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
	...
	var LeftNav = _wrapComponent("LeftNav")(function (_Component2) {
		...
		function LeftNav(props) {
			...
			var list = [{ text: "个人信息", link: "/user.html", icon: _icons.User }, { text: "购物车", link: "/user.html/chart.html", icon: _icons.Cart }, { text: "我的订单", link: "/user.html/deal.html", icon: _icons.Stack }, { text: "售后服务", link: "/user.html/serve.html", icon: _icons.UserTie }, { text: "消费足迹", link: "/user.html/track.html", icon: _icons.PushPin }, { text: "物流信息", link: "/user.html/diliver.html", icon: _icons.Airplane }];
			var list2 = [{ text: "店铺管理", link: "/user.html", icon: _icons.User }, { text: "订单管理", link: "/user.html/deal.html", icon: _icons.Stack }, { text: "客户服务", link: "/user.html/serve.html", icon: _icons.UserTie }, { text: "物流管理", link: "/user.html/diliver.html", icon: _icons.Airplane }];
			_this2.state = { choosed: 0, list: user && user.target == "saler" ? list2 : list };
			return _this2;
		}
		...
		(0, _createClass3.default)(LeftNav, [{
			...
			value: function render() {
				...
				return _react3.default.createElement(
					"div",
					{ style: { width: 250, padding: "30px 0", position: "absolute", top: 0, bottom: 0, background: "#555", overflow: "auto" } },
