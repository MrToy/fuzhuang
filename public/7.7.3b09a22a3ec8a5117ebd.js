			...
			value: function render() {
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						"div",
						{ style: { padding: "10px 30px", ":hover": { background: "#000" } } },
						_react3.default.createElement(
							"div",
							{ style: { color: "#fff", fontSize: 20, lineHeight: "40px", borderBottom: "1px solid rgba(255,255,255,0.5)" } },
			...
			value: function render() {
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							"div",
							{ style: { width: 250, padding: "20px 0", position: "absolute", top: 0, bottom: 0, background: "#555", overflow: "auto" } },
							[{ text: "个人信息", link: "#", icon: _icons.User }, { text: "购物车", link: "/user.html/chart.html", icon: _icons.Cart }, { text: "我的订单", link: "#", icon: _icons.Stack }].map(function (it) {
								return _react3.default.createElement(
									NavItem,
						...
						_react3.default.createElement(
							...
							_react3.default.createElement(
								"div",
								{ style: { padding: "0 30px", minHeight: 815 } },
								_react3.default.createElement(
									_main.TitleBar,
									{ text: true },
									"个人信息"
