...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extPjspaceFuzhuangNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
		filename: "/ext/pjspace/fuzhuang/src/user/info.jsx",
		components: _components,
		locals: [module],
		imports: [_react3.default]
	});
	...
	var AddressTable = _wrapComponent("AddressTable")(function (_Component3) {
		(0, _inherits3.default)(AddressTable, _Component3);
		...
		function AddressTable() {
			...
			(0, _classCallCheck3.default)(this, AddressTable);

			for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
				args[_key2] = arguments[_key2];
			}

			return _ret2 = (_temp2 = (_this4 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO2 = (0, _getPrototypeOf2.default)(AddressTable)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this4), _this4.state = { addModal: false, data: [], _id: "" }, _temp2), (0, _possibleConstructorReturn3.default)(_this4, _ret2);
		}

		(0, _createClass3.default)(AddressTable, [{
			key: "render",
			value: function render() {
				var _this5 = this;
				...
				var addr = _state.addr;
				var fullAddr = _state.fullAddr;
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						{ style: { marginBottom: 20 }, onClick: function onClick() {
								return _this5.setState({ addModal: true, _id: "" });
							} },
						"添加"
					),
					_react3.default.createElement(
						...
						_react3.default.createElement(_Input2.default, { value: addr, onChange: function onChange(e) {
								return _this5.setState({ addr: e.target.value });
							}, label: "所在地区" }),
						_react3.default.createElement(_Input2.default, { value: fullAddr, onChange: function onChange(e) {
								return _this5.setState({ fullAddr: e.target.value });
							}, label: "详细地址", type: "textarea" }),
						_react3.default.createElement(_Input2.default, { value: postcode, onChange: function onChange(e) {
								return _this5.setState({ postcode: e.target.value });
							}, label: "邮编", type: "number" }),
						_react3.default.createElement(_Input2.default, { value: tel, onChange: function onChange(e) {
								return _this5.setState({ tel: e.target.value });
						...
						_react3.default.createElement(
							...
							_react3.default.createElement(
								_Button2.default,
								{ onClick: function onClick() {
										_id == "" ? _this5.refs.post.request() : _this5.refs.put.request();
					...
					_react3.default.createElement(_Table2.default, { border: true, keys: ["收货人", "所在地区", "详细地址", "邮编", "手机号", "操作"], data: this.state.data.map(function (it) {
							var _id = it._id;
							var name = it.name;
							var addr = it.addr;
							var fullAddr = it.fullAddr;
							var postcode = it.postcode;
							var tel = it.tel;
							var def = it.def;

							return [name, addr, fullAddr, postcode, tel, _react3.default.createElement(
								"div",
								null,
								_react3.default.createElement(
									_Button2.default,
									{ color: def ? "default" : "primary", onClick: function onClick() {
											return _this5.setState({ _id: _id }, function () {
												return _this5.refs.def.request();
											});
										} },
									def ? "取消默认地址" : "设为默认地址"
								),
								_react3.default.createElement(
									_Button2.default,
									{ onClick: function onClick() {
											return _this5.setState({ addModal: true, _id: _id, name: name, addr: addr, fullAddr: fullAddr, postcode: postcode, tel: tel });
										} },
									"修改"
								),
								_react3.default.createElement(
									...
									{ color: "danger", onClick: function onClick() {
											return _this5.setState({ _id: _id }, function () {
												return _this5.refs.del.request();
											});
										} },
									"删除"
								)
					...
					_react3.default.createElement(_Ajax2.default, { ref: "post", method: "post", alert: true,
						url: "/addrs?token=" + _store2.default.get("token"),
						data: (0, _stringify2.default)({ name: name, addr: addr, fullAddr: fullAddr, postcode: postcode, tel: tel }),
						onSuccess: function onSuccess() {
							return _this5.setState({ addModal: false }, function () {
								return _this5.refs.get.request();
							});
						} }),
					_react3.default.createElement(_Ajax2.default, { ref: "del", method: "delete", alert: true,
						url: "/addrs/" + _id + "?token=" + _store2.default.get("token"),
						onSuccess: function onSuccess() {
							return _this5.refs.get.request();
						} }),
					_react3.default.createElement(_Ajax2.default, { ref: "put", method: "put", alert: true,
						url: "/addrs/" + _id + "?token=" + _store2.default.get("token"),
						data: (0, _stringify2.default)({ name: name, addr: addr, fullAddr: fullAddr, postcode: postcode, tel: tel }),
						onSuccess: function onSuccess() {
							return _this5.refs.get.request();
						} }),
					_react3.default.createElement(_Ajax2.default, { ref: "get", auto: true,
						url: "/addrs?token=" + _store2.default.get("token"),
						onSuccess: function onSuccess(it) {
							return _this5.setState({ data: it });
						} }),
					_react3.default.createElement(_Ajax2.default, { ref: "def", method: "put",
						url: "/addrs/def/" + _id + "?token=" + _store2.default.get("token"),
						onSuccess: function onSuccess() {
							return _this5.refs.get.request();
						} })
				);
				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							"div",
							{ title: "收货地址" },
							_react3.default.createElement(AddressTable, null)
						)
					)
				);
			}
