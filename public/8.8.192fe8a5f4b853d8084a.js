...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserInfo = _wrapComponent("UserInfo")(function (_Component) {
		...
		function UserInfo() {
			...
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(UserInfo).apply(this, arguments));
		}

		(0, _createClass3.default)(UserInfo, [{
			key: "componentDidMount",
			value: function componentDidMount() {
				this.refs.account.value = _store2.default.get('user').account;
			}
		}, {
			key: "render",
			value: function render() {
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						{ style: { margin: 20 } },
						"昵称：",
						_react3.default.createElement("input", { ref: "nickname" })
					),
					_react3.default.createElement(
						"div",
						{ style: { margin: 20 } },
						"账号：",
						_react3.default.createElement("input", { disabled: true, ref: "account" })
					),
					_react3.default.createElement(
						"div",
						{ style: { margin: 20 } },
