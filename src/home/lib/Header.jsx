			...
			<div style={{background:"#F6F6F6",borderBottom:"1px solid #CCC"}}>
				<div style={{width:1200,margin:"0 auto",lineHeight:2,fontSize:14,color:"#666"}}>
					<span>
						...
						{this.state.user&&<Link to="/user.html" style={{color:"inherit"}}  style={{marginLeft:20}}>Hi, {this.state.user.nickname||this.state.user.account}</Link>}
					...
					<span style={{float:"right"}}>
						{this.state.user&&<Link to="/user.html" style={{color:"inherit"}}  style={{marginLeft:20}}>用户中心</Link>}
