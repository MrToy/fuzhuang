		...
		return (
			<div style={[{padding:50,border:"1px solid "+colors.line,float:"right"},this.props.style]}>
				<div style={{border:"1px solid "+colors.line}}>
					...
					<input style={{display:"inline",border:"none",height:50,fontSize:30,width:280,paddingLeft:10}} />
				</div>
				<div style={{border:"1px solid "+colors.line,marginTop:30}}>
					...
					<input type="password" style={{display:"inline",border:"none",height:50,fontSize:30,width:280,paddingLeft:10}} />
				</div>
				<p style={{marginTop:30}}>
					<Link to="#">忘记密码？</Link>
					<Link to="#" style={{float:"right"}}>注册</Link>
				</p>
				<Link to="#">
					<div  style={{marginTop:30,background:colors.primary,color:"#fff",textAlign:"center",lineHeight:"50px",fontSize:20,fontWeight:"bold"}}>登 录</div>
				</Link>
			</div>
		)
	}
