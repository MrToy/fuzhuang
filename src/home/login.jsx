		...
		return (
			<div onKeyDown={event=>{if(event.keyCode==13)this.post()}} style={[{padding:50,border:"1px solid "+colors.line,float:"right"},this.props.style]}>
				<div style={{border:"1px solid "+colors.line}}>
					<svg style={{fill:"#888",display:"inline",verticalAlign:"top",width:50,height:50,padding:10,background:colors.bg,borderRight:"1px solid "+colors.line}} viewBox="0 0 20 20">
