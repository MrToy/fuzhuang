...
import List2 from './IconMoon/List2'
import ListNumbered from './IconMoon/ListNumbered'
import QuotesRight from './IconMoon/QuotesRight'
import Unlink from './Linearicons/Unlink'
import Link from './Linearicons/Link'
import Image from './IconMoon/Image'
import Undo2 from './IconMoon/Undo2'
import Redo2 from './IconMoon/Redo2'
import Eyedropper from './IconMoon/Eyedropper'
...
export default class extends Component{
	...
	render(){
		...
		return (
			<div style={{border:"1px dashed #CCC",marginTop:10,overflowX:"auto",minHeight:400,padding:10}}>
